...
CREATE TABLE IF NOT EXISTS `Test`.`Fiche_achat_matière` (
    `idFiche_achat_matière` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Test`.`Recette_pizza` (
    ...
    CONSTRAINT `fk_Recette_pizza_Pizza1` FOREIGN KEY (`Pizza_idPizza`)
...
CREATE TABLE IF NOT EXISTS `Test`.`Fiche_commande_has_Pizza` (
    ...
    CONSTRAINT `fk_Fiche_commande_has_Pizza_Fiche_commande1` FOREIGN KEY (`Fiche_commande_idFiche_commande`)
        REFERENCES `Test`.`Fiche_commande` (`idFiche_commande`)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_Fiche_commande_has_Pizza_Pizza1` FOREIGN KEY (`Pizza_idPizza`)
        REFERENCES `Test`.`Pizza` (`idPizza`)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB;
...
-- -----------------------------------------------------
-- Table `Test`.`Stock_has_Ingrèdient`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Test`.`Stock_has_Ingrèdient` (
  `Stock_idStock` INT NOT NULL,
  `Ingrèdient_idIngrèdient` INT NOT NULL,
  PRIMARY KEY (`Stock_idStock`, `Ingrèdient_idIngrèdient`),
  INDEX `fk_Stock_has_Ingrèdient_Ingrèdient1_idx` (`Ingrèdient_idIngrèdient` ASC),
  INDEX `fk_Stock_has_Ingrèdient_Stock1_idx` (`Stock_idStock` ASC),
  CONSTRAINT `fk_Stock_has_Ingrèdient_Stock1`
    FOREIGN KEY (`Stock_idStock`)
    REFERENCES `Test`.`Stock` (`idStock`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Stock_has_Ingrèdient_Ingrèdient1`
    FOREIGN KEY (`Ingrèdient_idIngrèdient`)
    REFERENCES `Test`.`Ingrèdient` (`idIngrèdient`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
